...
document.getElementById('crackleShell').addEventListener( 'click', function () {
	...
	launchManual(crackleShell);
});
document.getElementById('crossetteShell').addEventListener( 'click', function () {

	launchManual(crossetteShell);
});
document.getElementById('crysanthemumShell').addEventListener( 'click', function () {

	launchManual(crysanthemumShell);
});
document.getElementById('fallingLeavesShell').addEventListener( 'click', function () {

	launchManual(fallingLeavesShell);
});
document.getElementById('floralShell').addEventListener( 'click', function () {

	launchManual(floralShell);
});
document.getElementById('horsetailShell').addEventListener( 'click', function () {

	launchManual(horsetailShell);
});
...
document.getElementById('strobeShell').addEventListener( 'click', function () {

	launchManual(strobeShell);
});
document.getElementById('willowShell').addEventListener( 'click', function () {

	launchManual(willowShell);

});
document.getElementById('barrage').addEventListener( 'click', function () {

	launchManual(seqSmallBarrage);
});
document.getElementById('pyramid').addEventListener( 'click', function () {

	launchManual(seqPyramid);
});
...
var	shellTypes = {
	...
	function launchManual (type) 
	{	
		var size = document.querySelector('#shellSizeInput').value;
		var shellType = type;
		var shell = new Shell(shellType(size));
...
document.getElementById('launcher').addEventListener( 'click', function () {
	if (!running) {
		console.log("test");
		running = true;
		document.getElementById("status").innerText = "[Status]: Booting...";

		setTimeout( function () {
				document.getElementById("status").innerText = "[Status]: Comnnecting to launchers...";
		}, "1000");


		setTimeout( function () {
			document.getElementById("status").innerText = "[Status]: Preparing test-launch...";
		...
		setTimeout( function () {
			document.getElementById("status").innerText = "[Status]: Launching some fireworks...";
				seqPyramid();
				seqSmallBarrage();
		}, "6000");
		...
		setTimeout( function () {
				document.getElementById("status").innerText = "[Status]: Fireworks Simulator Ready";
				mintarea.style.display = "block";	
				nftarea.style.display = "block";	
				rafflearea.style.display = "block";	
				prizesarea.style.display = "block";	
				roadmaparea.style.display = "block";	
				launcharea.style.display = "none";
				running = false;
		}, "10000");
