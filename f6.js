...
document.getElementById('crackleShell').addEventListener( 'click', function () {
	...
	var element = document.getElementById("crackleShell");
  	element.classList.add("fireworks-container");
});
...
var	shellTypes = {
	...
	{
		var shellType = type;
		var shell = new Shell(shellType(10));
		shell.launch(getRandomShellPositionH(), getRandomShellPositionV());
	}
//	document.getElementByd("result").innerHTML = "Hello, I am here";
  var running = false;
